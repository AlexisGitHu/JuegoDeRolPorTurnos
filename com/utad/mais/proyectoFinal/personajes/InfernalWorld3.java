...
public class InfernalWorld3 extends Infernal
{
	/*
	 * Clase concreta del enemigo tipo Infernal mundo 3.
	 * 
	 ...
	 */
	private World world;
	public InfernalWorld3()
	{
		this(new OffensiveStrategy());
	}
	public InfernalWorld3(ActivityStrategy strategy)
	{
		super(strategy);
		this.world=World.LEVEL3;
	}
	public InfernalWorld3(Integer fuerza, Integer agilidad, Integer intelecto, Integer vida,ActivityStrategy strategy)
	{
