...
{
	/*
	 * Clase concreta del enemigo tipo Boss mundo 3.
	 * 
	...
	public BossWorld3(ActivityStrategy strategy)
	{
		super(strategy);
		this.world=World.LEVEL3;
	}
	public BossWorld3(Integer fuerza, Integer agilidad, Integer intelecto, Integer vida,ActivityStrategy strategy)
	{
