...
{
	/*
	 * Clase concreta del enemigo tipo Boss mundo 2.
	 * 
	...
	public BossWorld2(ActivityStrategy strategy)
	{
		super(strategy);
		this.world=World.LEVEL2;
	}
	public BossWorld2(Integer fuerza, Integer agilidad, Integer intelecto, Integer vida,ActivityStrategy strategy)
	{
