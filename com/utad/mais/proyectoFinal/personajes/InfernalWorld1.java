...
public class InfernalWorld1 extends Infernal
{
	/*
	 * Clase concreta del enemigo tipo Infernal mundo 1.
	 * 
	...
	public InfernalWorld1()
	{
		this(new OffensiveStrategy());
	}
	public InfernalWorld1(ActivityStrategy strategy)
	{
		super(strategy);
		this.world=World.LEVEL1;
	}
	public InfernalWorld1(Integer fuerza, Integer agilidad, Integer intelecto, Integer vida,ActivityStrategy strategy)
	{
