...
public class InquisitorWorld2 extends Inquisitor
{
	/*
	 * Clase concreta del enemigo tipo Inquisitor mundo 2.
	 * 
	 ...
	 */
	private World world;
	public InquisitorWorld2()
	{
		this(new OffensiveStrategy());
	}
	public InquisitorWorld2(ActivityStrategy strategy)
	{
		super(strategy);
		this.world=World.LEVEL2;
	}
	public InquisitorWorld2(Integer fuerza, Integer agilidad, Integer intelecto, Integer vida,ActivityStrategy strategy)
	{
