...
public class InquisitorWorld3 extends Inquisitor 
{
	/*
	 * Clase concreta del enemigo tipo Inquisitor mundo 1.
	 * 
	 ...
	 */
	private World world;
	public InquisitorWorld3()
	{
		this(new OffensiveStrategy());
	}
	public InquisitorWorld3(ActivityStrategy strategy)
	{
		super(strategy);
		this.world=World.LEVEL3;
	}
	public InquisitorWorld3(Integer fuerza, Integer agilidad, Integer intelecto, Integer vida,ActivityStrategy strategy)
	{
