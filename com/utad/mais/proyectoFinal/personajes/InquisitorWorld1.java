...
public class InquisitorWorld1 extends Inquisitor
{
	/*
	 ...
	 */
	private World world;
	public InquisitorWorld1()
	{
		this(new OffensiveStrategy());
	}
	public InquisitorWorld1(ActivityStrategy strategy)
	{
		super(strategy);
		this.world=World.LEVEL1;
	}
	public InquisitorWorld1(Integer fuerza, Integer agilidad, Integer intelecto, Integer vida,ActivityStrategy strategy)
	{
